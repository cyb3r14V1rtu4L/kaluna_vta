...
<div class="col-md-3">
<input type="date" name="sd" id="start_date" value="<?php if(isset($_GET["sd"])){ echo $_GET["sd"]; }?>" class="form-control">
</div>
<div class="col-md-3">
<input type="date" name="ed" id="end_date" value="<?php if(isset($_GET["ed"])){ echo $_GET["ed"]; }?>" class="form-control">
</div>
...
<?php
	...
	foreach($operations as $operation):
		$price_out = $operation->getProduct()->price_out;
		$sub_price_out = $operation->q * $price_out;
...
?>
	<tr>
		...
		<td><?php echo '$'.number_format($price_out,2,'.',','); ?></td>
		<td><?php echo '$'.number_format($sub_price_out,2,'.',','); ?></td>
		<!--<td><?php #echo $operation->getOperationType()->name; ?></td> -->
		<td><?php echo $operation->created_at; ?></td>
	</tr>

<?php
	$tot_price_out =  $tot_price_out + $sub_price_out;
	endforeach;
?>
	<tr>
		<td colspan="4"><b>TOTAL</b></td>
		<td><b><?php echo '$'.number_format($tot_price_out,2,'.',','); ?></b></td>
		<td>&nbsp;</td>
		<td>&nbsp;</td>
	</tr>
</table>
